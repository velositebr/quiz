...
@section('title')
    Editar {{ $authUser->name }} - Área Restrita
@endsection
    ...
    <div class="page-breadcrumb">
        <div class="row">
            <div class="col-7 align-self-center">
                <h3 class="page-title text-truncate text-dark font-weight-medium mb-1">Editar {{ $authUser->name }}</h3>
                <div class="d-flex align-items-center">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb m-0 p-0">
                            <li class="breadcrumb-item"><a href="/" class="text-muted">Painel</a></li>
                            <li class="breadcrumb-item text-muted active" aria-current="page">Editar meu perfil</li>
                        </ol>
                    </nav>
                </div>
            </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-12 col-md-6">
                                <form action="{{ route('backend.profile.update', $authUser) }}" method="POST" enctype="multipart/form-data">
                                    <div class="form-body">
                                        <label>Nome</label>
                                        <div class="row">
                                            <div class="col-md-12">
